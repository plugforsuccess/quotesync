-- ── policy_retention_status view ─────────────────────────────────────────────
-- Merges pending_cancel_events and renewal_events on policy_no within agency.
-- Each row = one policy with its cancel status, renewal status, or both.
-- risk_type: 'dual_risk' | 'pending_cancel' | 'renewal'
