    ...
    <div className="text-left flex-1">
      ...
      <div className="space-y-5 text-gray-700 text-base leading-relaxed">
        ...
        <div className="bg-white/80 rounded-xl p-5 border-2 border-blue-300 transition-all duration-300 hover:shadow-xl hover:scale-[1.02] hover:border-blue-400 active:scale-[0.98] cursor-pointer">
          ...
          <p className="text-base leading-relaxed">Technology makes it easier than ever to shop for insurance. <span className="font-semibold text-gray-900">Takes only 60 seconds</span> to securely start.</p>
        </div>
      </div>
