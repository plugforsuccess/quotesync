...
export default function RCUploadForm({ orgId, weekStart, employeeMap, onUploaded }) {
  ...
  async function doUpload(matchedRows, skippedCount) {
    ...
    if (error) {
      ...
      // Run alert scan via Edge Function
      try {
        ...
        setMsg({ type: 'warning', text: `${records.length} records uploaded${skipNote}. Alert scan failed — alerts will be generated by the nightly job.` });
      }
