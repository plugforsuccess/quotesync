...
export default function WeekPickerCalendar({ weekStart, onChange, label }) {
  ...
  // Determine which week row is selected
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 z-50 bg-white rounded-xl shadow-xl border border-gray-200 p-4 w-[300px]">
          {/* Month/Year header */}
