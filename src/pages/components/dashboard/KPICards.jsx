  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5">
        ...
        <div className="text-3xl font-bold text-gray-900">{submissions.toLocaleString()}</div>
        <div className="text-xs text-gray-400 mt-1">Target: 700/mo</div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5">
        ...
        <div className="text-xs text-gray-400 mt-1">Visits &rarr; Submissions</div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5">
        <div className="flex items-center justify-between mb-1">
          <span className="text-sm text-gray-500">Projected This Month</span>
        </div>
