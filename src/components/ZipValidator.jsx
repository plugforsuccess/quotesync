    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 relative animate-in fade-in zoom-in duration-200">
        ...
        <div className="text-center mb-6">
          <div className="w-16 h-16 bg-gradient-to-br from-brand-light to-brand2 rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <input
              ...
              className="w-full px-4 py-3 text-lg text-center text-gray-900 border-2 border-gray-200 rounded-xl focus:border-brand focus:ring-2 focus:ring-brand-weak outline-none transition-all"
              autoFocus
            />
            {error && (
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-brand to-brand2 text-white font-semibold py-3 px-6 rounded-xl hover:from-brand-dark hover:to-brand2 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-lg hover:shadow-xl"
          >
