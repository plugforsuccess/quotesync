...
const StickyQuoteBar = ({ onGetQuote }) => {
  ...
  return (
    ...
    >
      ...
      <div className="bg-gradient-to-r from-brand-dark via-brand to-brand2 backdrop-blur-xl shadow-2xl border-b border-white/20">
        {/* Animated gradient line */}
        <div className="absolute top-0 left-0 right-0 h-[2px] bg-accent animate-gradient-x"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex items-center justify-between gap-4">
            ...
            <button
              onClick={onGetQuote}
              className="group relative px-4 sm:px-6 py-2 sm:py-2.5 bg-white hover:bg-gray-50 text-brand font-bold text-sm sm:text-base rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-2 whitespace-nowrap overflow-hidden flex-shrink-0"
            >
              {/* Shimmer effect */}
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-brand-weak/50 to-transparent translate-x-[-200%] group-hover:translate-x-[200%] transition-transform duration-1000"></div>
